...
// ===== #167. 썸네일을 다루어주는 클래스 생성하기 =====
@Repository
public class LargeThumbnailManager {	// 원래의 이미지파일을 크게 만들어줌
	...
	public String doCreateThumbnail(String filename, String path) 
		...
		if(image.exists()) {
		    Thumbnails.of(image).size(800, 800).outputFormat(fileExt.substring(1)).toFile(thumbnail); 
		}
